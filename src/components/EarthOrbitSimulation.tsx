    ...
    <div className="rounded-2xl glass-panel border border-white/10 p-6 space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          {/* Speed Buttons */}
          <div className="flex items-center p-1 rounded-xl glass-panel bg-slate-900/80 border border-white/15">
            {[1, 10, 100].map((spd) => (
              <button
                key={spd}
          ...
          <button
            ...
            className="p-2 rounded-xl glass-panel bg-slate-900/80 border border-white/15 text-cyan-400 hover:text-cyan-300"
          >
      ...
      <div className="relative w-full h-[320px] bg-[#030612] rounded-xl border border-white/10 flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute bottom-4 left-4 glass-panel px-3 py-1.5 rounded-xl text-xs font-mono text-cyan-300 border border-cyan-500/30">
          Season: <span className="font-bold text-white">{getSeason(angle)}</span>
        </div>

        <div className="absolute bottom-4 right-4 glass-panel px-3 py-1.5 rounded-xl text-xs font-mono text-slate-300 border border-white/10">
